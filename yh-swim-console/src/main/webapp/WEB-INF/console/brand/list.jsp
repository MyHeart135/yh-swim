...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkBox(name, checked) {
            $("input[name=" + name + "]").attr("check", checked);
        }
        ...
        function optDelete(name, isDisplay, pageNum) {
            ...
            $("#jvForm").attr("action", "/brand/deleteBatch?name=" + name + "&isDisplay=" + isDisplay + "&pageNum=" + pageNum);
...
<div class="body-box">
        ...
        <table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
            ...
            <c:forEach items="${page.list }" var="brand">
                <tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
                    ...
                    <td align="center">
                        <a class="pn-opt" href="/brand/toEdit?id=${brand.id }">修改</a> | <a class="pn-opt"
	...
	<span class="r inb_a page_b">
		<c:forEach items="${pageView }" var="page">
            ${page }
        </c:forEach>
	</span>
    </div>
    <div style="margin-top:15px;"><input class="del-button" type="button" value="删除"
                                         onclick="optDelete('${name}','${isDisplay}','${page.pageNum}');"/></div>
</div>
</body>
</html>